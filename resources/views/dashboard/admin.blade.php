    ...
    <x-slot:header>
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                {{-- Bouton vers la liste des incidents --}}
                    ...
                    @foreach($byStatus as $status => $count)
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-100 rounded-full h-2">
                                ...
                                <div
                                    class="{{ $colors[$status] ?? 'bg-gray-400' }} h-2 rounded-full"
                                    style="width: {{ $percent }}%">
                                </div>
                        ...
                        @forelse($pendingIncidents as $incident)
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <span
                                        class="px-2.5 py-0.5 rounded-full text-xs font-medium {{ $priorityColors[$incident->priority] ?? 'bg-gray-100 text-gray-700' }}"
                                    >
